...
const PETS = ["🐱", "🦊", "🐰", "🐼", "🐨", "🐯", "🐸", "🐶"];
// 官方品牌标识（simple-icons 24x24 路径），仅用于标注对应的 agent
const AGENT_MARKS: Record<string, { fill: string; path: string }> = {
  claude: {
    fill: "#d97757",
...
export function PetDock({
  ...
  agents: PetAgent[];
  onContextMenu: (event: ReactMouseEvent<HTMLButtonElement>, instanceId: string) => void;
